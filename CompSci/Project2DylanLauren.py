...
#we inteded this function to guess around the point when the computer detects
...
def playerSetup():
    #cretaes graphics window for player and instruction text
...
#sets up GUI and ships for computer
